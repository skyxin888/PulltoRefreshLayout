...
public class PulltoRefreshFootView extends FrameLayout implements PulltoRefreshHeaderListener {
//    private MaterialFootWaveView materialWaveView;
    ...
    public PulltoRefreshFootView(Context context, AttributeSet attrs, int defStyle) {
...
//        materialWaveView = new MaterialFootWaveView(getContext());
